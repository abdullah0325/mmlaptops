...
export const metadata: Metadata = {
  title: "Quality & Safety Certificates | MM Laptop Center by Mubarak Foods",
  description:
    "Explore FDA, ISO 9001, ISO 22000, and Kosher certificates for Premium Laptops by MM Laptop Center, a brand of Mubarak Foods Pvt. Limited.",
  keywords: [
    "Premium Laptops Certificates",
    "FDA Certified Premium Salt",
  ...
  openGraph: {
    title: "Premium Laptops Certifications | MM Laptop Center",
    description:
      "Official quality and food safety certifications of MM Laptop Center Premium Laptops by Mubarak Foods Pvt. Limited.",
    type: "website",
  },
  robots: {
    index: true,
