...
const RamadanPackage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fcf5e8] py-10 px-4 flex justify-center">
      <div className="max-w-2xl w-full bg-white border-4 border-[#1E1F1C] p-6 md:p-10 shadow-2xl">
        
        {/* Header Section */}
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-2 text-[#0a0a0a]">
            سستا اور معیاری پیکیج
          </h1>
          <div className="flex items-center justify-center gap-4">
            <div className="h-1 w-12 md:w-20 bg-[#d8a928]"></div>
            <h2 className="text-2xl md:text-3xl font-bold whitespace-nowrap text-[#f6a45d]">
              برائے رمضان کریم
            </h2>
            <div className="h-1 w-12 md:w-20 bg-[#d8a928]"></div>
          </div>
          ...
          <table className="w-full border-collapse border-2 border-[#1E1F1C] text-center font-bold">
            <thead>
              <tr className="bg-[#fcf5e8] text-[#0a0a0a]">
                ...
                <th className="border-2 border-[#1E1F1C] p-2 text-sm md:text-base bg-[#f6a45d] text-white">
                  Discount Price
                </th>
              </tr>
            </thead>
            <tbody>
              {packageData.map((item, index) => (
                <tr key={index} className="hover:bg-[#fcf5e8] transition-colors">
                  <td className="border-2 border-[#1E1F1C] p-2 text-sm md:text-base text-[#0a0a0a]">
                    {item.name}
                  </td>
                  ...
                  <td className="border-2 border-[#1E1F1C] p-2 text-sm md:text-base font-black text-[#f6a45d]">
                    {item.discount}
                  </td>
                </tr>
              ))}
        ...
        {/* Price Banner */}
        <div className="mt-8 bg-[#f6a45d] text-white p-4 text-center rounded-sm">
        ...
        <div className="mt-10 flex flex-col items-center gap-6">
          <a 
            ...
            className="group relative inline-flex items-center justify-center px-12 py-4 font-bold text-white transition-all duration-200 bg-[#f6a45d] rounded-xl hover:bg-[#d8861f] w-full md:w-auto text-xl shadow-lg"
          >
            BUY NOW
          ...
          {/* Shipping Icons */}
          <div className="grid grid-cols-4 gap-2 pt-6 border-t border-[#d8a928] w-full opacity-80">
            {['HANDLE WITH CARE', 'THIS SIDE UP', 'FRAGILE', 'KEEP DRY'].map((label, i) => (
              <div key={label} className="flex flex-col items-center text-[8px] md:text-[10px] font-bold text-[#0a0a0a]">
                <div className="h-10 w-10 md:h-12 md:w-12 border-2 border-[#1E1F1C] rounded flex items-center justify-center mb-1 text-lg bg-[#fcf5e8]">
                  {['📦', '↑↑', '🍷', '☔'][i]}
                </div>
