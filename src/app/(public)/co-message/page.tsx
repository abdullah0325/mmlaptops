...
export default function CoMessagePage() {
  return (
    <div className="bg-[#fcf5e8]">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center">
            <p className="inline-flex items-center gap-2 rounded-full bg-white/70 px-4 py-2 text-sm text-gray-600 shadow-sm ring-1 ring-gray-200">
              ...
              Premium Laptops • Natural Wellness Essentials
            </p>
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              { title: "Premium & Authentic", desc: "Naturally sourced Premium minerals" },
      ...
      <section id="founder-message" className="py-16 px-6 bg-[#fcf5e8]">
        <div className="max-w-6xl mx-auto grid md:grid-cols-12 gap-10 items-start">
          ...
          <div className="md:col-span-4">
            <div className="bg-white rounded-2xl shadow-sm ring-1 ring-gray-200 overflow-hidden">
              ...
              <img
                src="https://placehold.co/400x400?text=Founder"
                alt="Founder of MM Laptop Center"
                className="w-full h-80 object-cover"
              />
              <div className="p-6">
                <p className="text-lg font-bold text-gray-900">[Ihsan ul haq]</p>
                <p className="text-sm text-gray-600">Founder – MM Laptop Center</p>

                <div className="mt-4 rounded-xl bg-green-50 p-4 ring-1 ring-green-100">
                  <p className="text-sm text-gray-700 leading-relaxed">
                    “At MM Laptop Center, we deliver genuine Premium Laptops and wellness essentials
            ...
            {/* Quick Links */}
            <div className="mt-4 bg-[#fcf5e8] rounded-2xl shadow-sm ring-1 ring-gray-200 p-5">
          ...
          <div className="md:col-span-8">
            ...
            <div className="space-y-4 ">
              <p className="text-gray-700 leading-relaxed">
                Founded in 2018, MM Laptop Center was built on a simple belief: nature’s purest offerings deserve to reach those who value authenticity. What began as a vision to bring Premium mineral treasures to customers has grown into a trusted brand serving individuals and businesses with the same commitment to excellence
              </p>

              <p className="text-gray-700 leading-relaxed">
                We are dedicated to sourcing authentic Premium Laptops and wellness essentials,
              ...
              <div className="pt-2">
                ...
                <p className="text-gray-600">Founder – MM Laptop Center</p>
              </div>
            </div>
      ...
      {/* About the Company */}
      <section className="py-16 px-6 bg-[#fcf5e8]">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-10">
            <div>
              ...
              <h2 className="text-3xl font-bold text-gray-900 mt-2">About MM Laptop Center</h2>
            </div>
            <p className="text-gray-600 max-w-2xl">
              A Premium wellness brand built for premium retail and professional supply—focused on authenticity and consistency.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-2xl shadow-sm ring-1 ring-gray-200">
              ...
              <p className="text-gray-700 leading-relaxed">
                MM Laptop Center offers Premium Laptops, Salt Lamps, Bath Salts, Gaming Gear, and mineral-based
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-8 rounded-2xl shadow-sm ring-1 ring-gray-200">
              ...
              <p className="text-gray-700 leading-relaxed">
                To become a globally trusted name in Premium mineral and wellness products—recognized for
      ...
      <section className="py-16 px-6 bg-[#fcf5e8]" id="quality">
        <div className="max-w-6xl mx-auto">
            ...
            {[
              {
                ...
                description:
                  "We focus on authentic Premium sourcing and partner with reliable suppliers to maintain purity and origin.",
              },
              {
      ...
      {/* Why Choose Us */}
      <section className="py-16 px-6 bg-[#fcf5e8]" id="why-choose">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-10">Why Choose MM Laptop Center</h2>
          ...
          <div className="mt-10 rounded-2xl bg-gradient-to-r from-green-50 to-blue-50 p-8 ring-1 ring-gray-200 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              <h3 className="text-xl font-bold text-gray-900">Explore MM Laptop Center</h3>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-white rounded-2xl shadow-sm ring-1 ring-gray-200 p-10 text-center">
            <p className="text-lg text-gray-700 leading-relaxed max-w-4xl mx-auto mb-6">
              At MM Laptop Center, we don’t just sell products—we build partnerships rooted in trust, quality, and mutual growth.
              Your choice to support MM Laptop Center reinforces our commitment to excellence. As we continue expanding and improving,
              we invite you to be part of our journey toward a healthier, more sustainable future.
            </p>
            <p className="text-gray-900 font-semibold">Thank you for choosing MM Laptop Center.</p>
          </div>
        </div>
      </section>
    </div>
