...
export function CollectionForm({
  ...
  return (
    <div className="p-8">
      ...
      <form
        onSubmit={onSubmit}
        className="grid gap-6 rounded-xl border border-[#d8a928]/20 bg-white p-6 lg:grid-cols-2"
      >
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-[#0a0a0a]">Handle</label>
            <input
              value={values.handle}
              onChange={(e) => setValues((v) => ({ ...v, handle: e.target.value }))}
              className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 font-mono text-sm focus:ring-2 focus:ring-[#d8a928] focus:border-transparent"
              required
            />
          </div>
