    ...
    <div className="p-8 max-w-4xl">
      ...
      <form onSubmit={onSubmit} className="space-y-6">
        <div className="rounded-xl border border-[#d8a928]/20 bg-white p-6">
          <h2 className="text-lg font-semibold text-[#0a0a0a] mb-4">Section Header</h2>
          <div className="grid gap-4">
            <div>
              <label className="block text-sm font-medium text-[#0a0a0a]">Title</label>
              <input
                value={title}
            ...
            <div>
              <label className="block text-sm font-medium text-[#0a0a0a]">Subtitle</label>
              <input
                value={subtitle}
        ...
        <div className="rounded-xl border border-[#d8a928]/20 bg-white p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-[#0a0a0a]">Cards</h2>
            <button
              type="button"
              onClick={() => setEssenceCards([...essenceCards, { title: "", description: "", image: "" }])}
              className="text-sm text-[#f6a45d] hover:underline"
            >
              + Add Card
            </button>
          </div>
            ...
            {essenceCards.map((card, index) => (
              <div key={index} className="space-y-4 relative">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-medium text-[#0a0a0a]">Card {index + 1}</h3>
