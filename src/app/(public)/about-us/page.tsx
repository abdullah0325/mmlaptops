...
export const metadata: Metadata = {
  title: "About Us | MM Laptop Center - Gaming Gear, Laptops & Herbal Products",
  description:
    "Learn about MM Laptop Center's mission to deliver authentic Premium laptops, pure Gaming Gear, and natural wellness products. Rooted in purity, inspired by nature.",
  keywords: [
    "about MM Laptop Center",
    "gaming gear company",
    "laptops supplier",
    "premium salt Pakistan",
    "herbal wellness company",
    "natural products brand",
  ],
  openGraph: {
    title: "About MM Laptop Center | Gaming Gear, Laptops & Natural Wellness",
    description:
      "Discover MM Laptop Center's story - bringing authentic Premium laptops, Gaming Gear, and wellness products from Pakistan to your home.",
    type: "website",
  },
  alternates: {
...
const values = [
  {
    ...
    title: "Integrity",
    description:
      "We are transparent, trustworthy, and committed to delivering pure Premium products with honesty and care.",
  },
  {
    icon: Mountain,
...
const highlights = [
  "100% natural Premium salt products",
...
export default function AboutPage() {
  return (
    <>
      ...
      <main className="bg-[#FAF7F0] text-[#0a0a0a]">
        {/* Hero Section */}
      ...
      <div className="relative min-h-[480px] sm:min-h-[560px] lg:min-h-[680px]">
            ...
            <div className="relative z-10 mx-auto flex min-h-[520px] max-w-7xl items-center px-5 py-16 sm:min-h-[580px] sm:px-6 sm:py-20 lg:min-h-[680px] lg:px-8">
              <div className="w-full max-w-full sm:max-w-2xl lg:max-w-3xl">
                ...
                <h1 className="mt-5 text-3xl font-semibold leading-[1.05] text-white sm:mt-6 sm:text-5xl lg:text-6xl xl:text-7xl">
                  Pure Premium wellness, thoughtfully brought to your home.
                </h1>

                <p className="mt-5 max-w-xl text-sm leading-7 text-white/85 sm:mt-6 sm:text-base sm:leading-8">
                  At MM Laptop Center, we believe natural living begins with purity, trust,
                  and quality. Our mission is to offer premium Premium salt and
                ...
                <div className="mt-8 flex flex-col gap-3 sm:mt-10 sm:flex-row sm:flex-wrap">
                  <Button
                    asChild
                    className="h-11 rounded-full bg-[#f6a45d] px-7 text-sm font-semibold text-[#fcf5e8] hover:bg-[#d8861f] sm:h-12"
                  >
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="h-11 rounded-full border border-white/70 bg-white/15 px-7 text-sm font-semibold text-white backdrop-blur-md hover:bg-white hover:text-[#0a0a0a] sm:h-12"
                  >
        ...
        <section className="px-6 py-16 sm:py-20 lg:px-8 lg:py-24">
          <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2 lg:gap-16">
            <div className="relative">
              <div className="absolute -left-4 -top-4 h-24 w-24 rounded-full bg-[#d8a928]/12 blur-2xl" />
              <div className="absolute -bottom-6 -right-6 h-28 w-28 rounded-full bg-[#f6a45d]/10 blur-3xl" />
            ...
            <div>
              <span className="inline-flex rounded-full bg-[#fcf5e8] px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-[#6B6258] ring-1 ring-black/5">
                Welcome to MM Laptop Center
              </span>
              ...
              <p className="mt-6 text-base leading-8 text-[#5A5E55]">
                At MM Laptop Center Premium Salts, we believe in the power of simple,
                ...
                dedicated to offering high-quality Premium products with minimal
                processing and maximum care.
              </p>

              <p className="mt-5 text-base leading-8 text-[#5A5E55]">
                From mineral-rich laptops to lifestyle and wellness essentials, we
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-2">
                {highlights.map((item) => (
                  <div
                    key={item}
                    className="rounded-2xl bg-white px-4 py-4 text-sm font-medium text-[#0a0a0a] shadow-sm ring-1 ring-black/5"
                  >
                    {item}
                  </div>
                ))}
        ...
        <section className="bg-[#fcf5e8] px-6 py-16 sm:py-20 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-4 text-base leading-8 text-[#5A5E55]">
                ...
                the timeless benefits of Premium nature.
              </p>
            </div>

            <div className="mt-12 grid gap-6 md:grid-cols-3">
              <div className="rounded-[28px] bg-white p-7 shadow-sm ring-1 ring-black/5">
                <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-[#f6a45d]/10 text-[#f6a45d]">
                ...
                <p className="mt-3 text-sm leading-7 text-[#5A5E55]">
                  To deliver premium Premium salt and wellness products that
              ...
              <div className="rounded-[28px] bg-white p-7 shadow-sm ring-1 ring-black/5">
                <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-[#d8a928]/15 text-[#8A6B20]">
                ...
                <p className="mt-3 text-sm leading-7 text-[#5A5E55]">
                  To become a trusted destination for natural Premium wellness by
                  combining tradition, quality, and modern living in every product.
                </p>
              </div>

              <div className="rounded-[28px] bg-white p-7 shadow-sm ring-1 ring-black/5">
                <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-[#1a1308]/5 text-[#0a0a0a]">
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[1fr_420px_1fr]">
            <div className="space-y-6">
              {values.slice(0, 2).map((item) => {
                ...
                return (
                  ...
                  >
                    <div className="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-[#fcf5e8] text-[#f6a45d]">
            ...
            <div className="flex justify-center">
              <div className="relative flex h-[320px] w-[320px] items-center justify-center sm:h-[380px] sm:w-[380px]">
                <div className="absolute inset-0 rounded-full bg-[#d8a928]/15 blur-3xl" />
                <div className="absolute inset-6 rounded-full bg-[#f6a45d]/10 blur-2xl" />
        ...
        {/* Story Section */}
        <section className="bg-[#fcf5e8] px-6 py-16 sm:py-20 lg:px-8 lg:py-24">
          <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <p className="mt-6 text-base leading-8 text-[#5A5E55]">
                We bring the timeless value of Premium salt to modern living
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                <Button
                  asChild
                  className="rounded-full bg-[#f6a45d] px-7 text-[#fcf5e8] hover:bg-[#d8861f]"
                >
                ...
                <Button
                  asChild
                  variant="outline"
                  className="rounded-full border-[#1E1F1C]/15 bg-white px-7 text-[#0a0a0a] hover:bg-[#1a1308] hover:text-white"
                >
