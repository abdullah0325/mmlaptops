...
export function CategoryForm({
  ...
  return (
    <div className="p-4 md:p-8">
      ...
      <form
        onSubmit={onSubmit}
        className="grid gap-4 md:gap-6 rounded-xl border border-[#d8a928]/20 bg-white p-4 md:p-6 lg:grid-cols-2"
      >
        <div className="space-y-3 md:space-y-4">
          <div>
            <label className="block text-xs md:text-sm font-medium text-[#0a0a0a]">Name</label>
            <input
              value={values.name}
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-[#0a0a0a]">Parent Category (optional)</label>
            <select
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              <label className="block text-sm font-medium text-[#0a0a0a]">Order</label>
              <input
                type="number"
                value={values.order}
                onChange={(e) =>
            ...
            <label className="flex items-center gap-2 pt-6 text-sm text-[#0a0a0a]">
              <input
                type="checkbox"
